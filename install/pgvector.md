...
LY-NEXT 的 RAG 依赖 PostgreSQL 的 **vector** 扩展。安装方式见 [pgvector 官方文档](https://github.com/pgvector/pgvector#installation)（APT/Yum/Homebrew/Docker/源码/托管库）。

日常使用可走统一安装脚本或 Docker；本文档用于手动排错与未覆盖的发行版。
...
# 若本机已安装 Git 与 Visual Studio C++ 构建工具，安装脚本会尝试自动编译
